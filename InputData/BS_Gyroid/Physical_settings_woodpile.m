function phys = Physical_settings_woodpile(problem_name, gamma, radius)
    global tau
    ...
    switch phys.problem_name
        ...
        case "FCC_tri"
            ...
            % Trigonal Frustum
            para1 = sqrt(3)/2*radius*0.5; para2 = 0.5*radius*0.5;
            para3 = radius*0.5;
            h1 = radius * 0.7; h2 = (2-radius)*0.3;
            
            % 两个三棱锥
            phys.geometry.tri_fru_top = [  0.5-para1  0.5-para2   h1;
                                           0.5+para1  0.5-para2   h1;
                                           0.5        0.5+para3   h1;
                                           0.5        0.5         0.5;
                                           0.5        0.5         0.5;
                                           0.5        0.5         0.5 ];
            phys.geometry.tri_fru_bot = [  0.5        0.5         0.5;
                                           0.5        0.5         0.5;
                                           0.5        0.5         0.5;
                                           0.5-para1  0.5-para2   h2;
                                           0.5+para1  0.5-para2   h2;
                                           0.5        0.5+para3   h2];   
        case 'woodpile'
            phys.geometry.supercell_num = [1,1,1]; 
    ...
    switch phys.problem_name
        case {'FCC_square', 'FCC_sphere', 'FCC_tri', 'woodpile'}
            xi = [-1 3 2; 2 -3 1; 4 5 -1]; 
            epsi = [5 2 1;2 5 2;1 2 4];
            phys.permittivity{2} = epsi;
            phys.permeability{2} = xi' * inv(epsi) * xi;
            phys.magnetoelectric_Xi{2} = gamma*1i * xi;
            phys.magnetoelectric_zeta{2} = -gamma*1i * xi'; 
    end
    ...
    switch phys.problem_name
        case 'HEX'
            path_string = 'GKMKHAG';
        case {'FCC', 'No227_FCC_SiO2', 'FCC_square', 'FCC_sphere', 'FCC_tri', 'woodpile'}
            path_string = 'XULGXWK'; % 'XULGXWK';GXWKGLUWLK|UX
        case {'No198_SC_FeSi', 'SC_test'}  
